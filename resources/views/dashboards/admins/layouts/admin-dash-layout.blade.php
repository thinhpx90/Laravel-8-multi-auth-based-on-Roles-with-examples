...
{{--            <li class="nav-item">--}}
{{--                <a href="{{ route('admin.experience')}}" class="nav-link {{ (request()->is('admin/experience*')) ? 'active' : '' }}">--}}
{{--                    <i class="nav-icon fas fa-user"></i>--}}
{{--                    <p>--}}
{{--                        Experience--}}
{{--                    </p>--}}
...
{{--            </li>--}}
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/admin/experience/add" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Thêm kinh nghiệm</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/admin/experience/list" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>List kinh nghiệm</p>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="/admin/list-file" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>List File</p>
                        </a>
                    </li>
